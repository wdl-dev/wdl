...
const doRuntimeModules :List(Workerd.Worker.Module) = [
    ...
    (name = "runtime-infrastructure-error", esModule = embed "../runtime/infrastructure-error.js"),
    ...
    (name = "runtime-bindings-kv-capacity", esModule = embed "../runtime/bindings/kv-capacity.js"),
    ...
    (name = "runtime-bindings-ai", esModule = embed "../runtime/bindings/ai.js"),
    (name = "runtime-bindings-ai-capacity", esModule = embed "../runtime/bindings/ai-capacity.js"),
    (name = "runtime-bindings-ai-provider", esModule = embed "../runtime/bindings/ai-provider.js"),
    (name = "runtime-bindings-ai-sse", esModule = embed "../runtime/bindings/ai-sse.js"),
    (name = "runtime-bindings-ai-websocket", esModule = embed "../runtime/bindings/ai-websocket.js"),
    ...
    (name = "runtime-bindings-workflow", esModule = embed "../runtime/bindings/workflow.js"),
    (name = "runtime-dispatch-workflow-json", esModule = embed "../runtime/dispatch/workflow-json.js"),
    (name = "runtime-do-transport", esModule = embed "../runtime/_wdl-do-transport.js"),
    (name = "_wdl-do-scoped-request.js", esModule = embed "../runtime/_wdl-do-scoped-request.js"),
    (name = "_wdl-request-id.js", esModule = embed "../runtime/_wdl-request-id.js"),
    ...
    (name = "runtime-do-scoped-request-source", text = embed "../runtime/_wdl-do-scoped-request.js"),
    ...
    (name = "runtime-ai-client-source", text = embed "../runtime/ai-client.js"),
