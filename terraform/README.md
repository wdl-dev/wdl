...
`do_runtime_container_memory`, but the DO override must still stay below
`runtime_memory`. This matters because newer workerd releases no longer cap SQLite's
