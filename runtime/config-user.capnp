...
const loaderWorker :Workerd.Worker = (
  modules = [
    ...
    (name = "runtime-infrastructure-error", esModule = embed "infrastructure-error.js"),
    ...
    (name = "runtime-bindings-kv-capacity", esModule = embed "bindings/kv-capacity.js"),
    ...
    (name = "do-runtime-protocol-wire-grammar", esModule = embed "../do-runtime/protocol/wire-grammar.js"),
    ...
    (name = "runtime-utf8-source", text = embed "../shared/utf8.js"),
