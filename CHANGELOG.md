...
- Added bounded Workflow definition pagination and CLI continuation support, with per-worker limits of 1024 retained names and 1 MiB of definition data. Large metadata snapshots fail before transfer instead of materializing an unbounded namespace view.
