...
| Workflow deletion preflight | `tests/fixtures/workflow-lifecycle-check.json` 拥有 request 与 complete/blocked/continuation response variant。Rust 拥有有界 scan/member work；Control 拥有有界续接、response read 和 delete-lock renewal。未完成扫描绝不是删除授权。 |
