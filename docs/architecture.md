...
- DB 0 on the Workflows endpoint: only the Workflows-owned operator schema-migration state.
...
- DB 15: inactive schema-2 Workflow archive retained until explicitly deleted; no
