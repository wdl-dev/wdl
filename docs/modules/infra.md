...
- DB 0 on the Workflows endpoint: only the Workflows-owned schema-migration state. It is
...
- DB 15: inactive schema-2 Workflow archive retained until explicitly deleted after migration.
