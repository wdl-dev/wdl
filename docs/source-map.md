...
| `runtime/bindings/workflow.js`, `runtime/workflows-client.js`, `runtime/dispatch/workflow-*.js`, `runtime/load/wrapper-generate.js` | Workflow binding-scoped transport, facade materialization, identity injection, dispatch facade, replay cache, and step semantics. |
